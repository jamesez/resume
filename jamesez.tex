...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\href{https://jamesez.io/}{\Large Jim Zajkowski}} & github: \href{https://github.com/jamesez}{jamesez} and \href{https://github.com/umich-mac}{umich-mac}\\
  \href{mailto:jim@jamesez.io}{jim\ @\ jamesez.io} & 734-846-1988 \\
\end{tabular*}
      ...
      \resumeSubSubheading
        ...
        \resumeItemListStart
          \resumeItem{Izzy as a Service}
            {To expand the scope of Mac management to all of campus, I proposed and led an initiative to sell Izzy, the Ruby platform I developed to control \munki\ and Jamf, as an independent service. I met with unit leadership, technical stakeholders, and end-users to understand their needs and discuss the benefits of embracing Mac management technologies. I provided pilots, training, and ongoing support during each unit's full-scale roll-out process. I coordinated bringing on all but one campus department, school, and college -- from dozens to thousands of systems -- including Michigan Medicine (PHI), the College of Engineering (ITAR), Ross Business School, and the Dearborn campus. As of today, we have just over 10,000 systems under management. I have worked with Michigan Medicine on splitting their VMware Workspace One environment to only provide management for BYOD systems. For my work on Izzy, I received the President's Staff Award of Distinction in 2019.
            }

          \resumeItem{Izzy Client}
            {In preparation for Apple Silicon systems, I rewrote our library of on-client scripts and tools -- many in Ruby or Bash -- into a single unified Swift binary. This frees us from relying on a scripting runtime or installing one on each client. Additionally enables TCC controls for full disk access and exceptions from EDR tools.
            }

          \resumeItem{Izzy at Home}
            {When COVID-19 hit, I was able to scale up our emergency-use zero-touch install method to full production within a week, and we were primarily using zero-touch by the end of March 2020. I unified our bootstrap process to work for either on-campus or at-home deployments, and we continue to use zero-touch with about 1 in 4 systems. We also use zero-touch in situations where a system needs to be returned to service and it is inconvenient for the customer to bring it to campus. I worked with our Windows team to help build an offline domain join registry in Go for their InTune-based at-home deployment.}

          \resumeItem{Additional Tooling}
            {I wrote and deployed an API server -- written in Swift Vapor, deployed to Kubernetes -- for our block-M menubar tool. I created a few automations in Go (and deployed to Kubernetes) to validate our Jamf database, and then notify us in Slack -- for example, when a duplicate system is registered after a logic board replacement.}
          ...
          \resumeItem{Plenary Developer}
            {I have been a lead developer on tools for collaborative services, including a Microsoft Teams creation and synchronization engine to Azure ActiveDirectory, a pre-flight validator for Slack Enterprise migrations, and GitHub Enterprise internal tooling (all in Ruby). I am a member of the Technology Review Board which all new projects must meet with before developing solutions. I have been an early adopter of cloud, devops, and container technologies, and advise on and advocate for modern devops practices.}
        \resumeItemListEnd
...
%  \resumeSubHeadingListStart
%    \item{
%      \textbf{Languages}{: Comprehensive knowledge of Ruby, Objective-C and Swift. Adept at Go, both client and server-side, and Go is area of recent focus for me. Working knowledge of Python.}
%      \hfill
%      \textbf{Open Source}{: My open source releases are published under github.com/jamesez and github.com/umich-mac}
%    }
%  \resumeSubHeadingListEnd
