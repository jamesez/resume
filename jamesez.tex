      ...
      \resumeSubSubheading
        ...
        \resumeItemListStart
          \resumeItem{Izzy as a Service}
            {For those University units that preferred to run their own desk-side support, we internally re-sold our management platform. Much like the MiWorkspace rollout, I met with unit leadership, technical stakeholders, and end-users to answer questions about Mac management capabilities and technologies. I successfully coordinated bringing on Michigan Medicine (PHI), the College of Engineering (ITAR), Ross Business School, and as of today, all but one department to the platform. We also added the Dearborn campus. We have just over 10,000 systems under management, which continues to grow as units rebuild into our toolchain. I have consulted with Michigan Medicine involving issues with their VMware Workspace One environment, which they use for BYOD devices.}
          ...
          \resumeItem{Izzy at Home}
            {When COVID-19 hit, I was able to fix and scale up our emergency-use zero-touch installs to full production within a week, and were completely zero-touch by the end of March 2020. I unified our bootstrap process to work in either on-campus or at-home and we continue to use zero-touch with about 1 in 4 systems. We also use zero-touch in situations where a system needs to be reloaded but it isn't convenient for the customer to return it to campus. I worked with our Windows team to help build an offline domain join registry for their InTune-based at-home deployment.}
          ...
          \resumeItem{Plenary Developer}
            {I have been a lead developer on tools for collaborative services, including a Microsoft Teams creation and syncronization engine, a pre-flight advisor for Slack Enterprise migrations, and GitHub Enterprise internal re-billing for services. I am a member of the Technology Review Board which all new projects must meet with before developing solutions. I have been an early adopter of cloud, devops, and container technologies, and advise on and advocate for modern devops practices.}
        \resumeItemListEnd
